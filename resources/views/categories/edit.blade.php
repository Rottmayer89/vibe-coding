<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Category Form Card -->
            <x-card title="Edit Category Information" footer='codeyad.com'>
                <x-form.container action="{{ route('categories.update', $category) }}" method="POST" id="categoryForm"
                    class="space-y-6">
                    @csrf
                    @method('PATCH')
                    ...
                    <x-form.input name="name" label="Category Name" placeholder="Enter category name" required
                        maxlength="100" oninput="validateName(this)" :value="$category->name" />
