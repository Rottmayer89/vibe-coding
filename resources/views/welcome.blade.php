...
<body
    ...
    <div class="w-full max-w-4xl p-8 mb-8 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        <h1 class="text-3xl font-semibold text-gray-900 dark:text-white mb-6">Welcome to Vibe.AI</h1>

        <!-- Alpine.js Demo Component -->
        <div x-data="{ open: false, count: 0 }" class="space-y-6">
            <!-- Tailwind CSS styled button with Alpine.js click handler -->
            <button @click="open = !open"
                class="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded transition-colors duration-200">
                Toggle Content
            </button>

            <!-- Content that appears/disappears with Alpine.js -->
            <div x-show="open" x-transition:enter="transition ease-out duration-300"
                ...
                class="p-6 bg-gray-100 dark:bg-gray-700 rounded-lg">
                <p class="text-gray-800 dark:text-gray-200">This content appears and disappears smoothly with Alpine.js
                    transitions!</p>
            </div>

            <!-- Counter example with Alpine.js -->
            <div class="flex items-center space-x-4">
                ...
                <div class="text-xl font-semibold text-gray-900 dark:text-white">
                    Count: <span x-text="count" class="text-blue-500 dark:text-blue-400"></span>
                </div>
            </div>
        </div>
    </div>
